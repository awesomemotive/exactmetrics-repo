...
$generated_i18n_strings = array(
	...
	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:213
	...
	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:112
	...
	// Reference: src/modules/about/components/exactmetrics-AboutTabLiteVsPro.vue:146
	...
	// Reference: src/modules/settings/components/network/SettingsInputLicenseNetwork-Lite.vue:25
	...
	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:81
	__( 'Authenticating', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:143
	__( 'Verifying Credentials', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate-Lite.vue:185
	__( 'Your site is connected to ExactMetrics!', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:182
	...
	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate-Lite.vue:67
	...
	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:49
	__( 'Verify Credentials', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:51
	__( 'Website Profile', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:52
	__( 'Active Profile', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate-Lite.vue:72
	...
	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate-Lite.vue:73
	...
	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate-Lite.vue:76
	__( 'Or manually enter UA code (limited functionality)', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:61
	__( 'Force Deauthenticate', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate-Lite.vue:85
	...
	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:160
	__( 'Your site is connected to ExactMetrics!', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:202
	__( 'You\'ve disconnected your site from ExactMetrics. Your site is no longer being tracked by Google Analytics and you won\'t see reports anymore.', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:48
	__( 'Connect ExactMetrics', 'google-analytics-dashboard-for-wp' ),

	// Reference: src/modules/settings/components/input/tab-general/exactmetrics-SettingsInputAuthenticate.vue:50
	__( 'Reconnect ExactMetrics', 'google-analytics-dashboard-for-wp' ),
